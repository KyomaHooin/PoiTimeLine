...
$name = array_map(function ($var) { return preg_replace('/\.json$/','' ,$var); }, $data);
...
<?php
	...
	echo '<tr><td class="text-end">Location:</td><td>';
	echo implode(', ', $jsn['location']) . '</td></tr>';
	...
	echo '<tr><td class="text-end">Music:</td><td>';
	echo implode(', ', $jsn['music']) . '</td></tr>';
