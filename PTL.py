...
class MainWindow(QMainWindow):
	def __init__(self):
		...
		self.group_logo = QLabel("Logo")
		self.formLayout_2.setWidget(1, QFormLayout.ItemRole.LabelRole, self.group_logo)
		self.group_logo_text = QLineEdit()
		self.formLayout_2.setWidget(1, QFormLayout.ItemRole.FieldRole, self.group_logo_text)
		self.group_artist = QLabel("Artist")
		self.formLayout_2.setWidget(2, QFormLayout.ItemRole.LabelRole, self.group_artist)
		self.group_artist_text = QTextEdit()
		self.group_artist_text.setAcceptRichText(0)
		self.formLayout_2.setWidget(2, QFormLayout.ItemRole.FieldRole, self.group_artist_text)
		self.group_location = QLabel("Location")
		self.formLayout_2.setWidget(3, QFormLayout.ItemRole.LabelRole, self.group_location)
		self.group_location_text = QLineEdit()
		self.formLayout_2.setWidget(3, QFormLayout.ItemRole.FieldRole, self.group_location_text)
		self.group_country = QLabel("Country")
		self.formLayout_2.setWidget(4, QFormLayout.ItemRole.LabelRole, self.group_country)
		self.group_country_text = QLineEdit()
		self.formLayout_2.setWidget(4, QFormLayout.ItemRole.FieldRole, self.group_country_text)
		self.group_meta = QLabel("Meta")
		self.formLayout_2.setWidget(5, QFormLayout.ItemRole.LabelRole, self.group_meta)
		self.group_meta_text = QTextEdit()
		self.group_meta_text.setAcceptRichText(0)
		self.formLayout_2.setWidget(5, QFormLayout.ItemRole.FieldRole, self.group_meta_text)
		...
		self.video_GetAudioStartEdit = QLineEdit("00:00:00")
		self.video_GetAudioStartEdit.setAlignment(Qt.AlignmentFlag.AlignHCenter)
		self.video_GetAudioEnd = QLabel("End")
		self.video_GetAudioEndEdit = QLineEdit("00:00:00")
		self.video_GetAudioEndEdit.setAlignment(Qt.AlignmentFlag.AlignHCenter)
		...
		if data:
			match os.path.basename(os.path.dirname(fn)):
				...
				case "group":
					...
					self.group_logo_text.setText(data['logo'] if 'logo' in data else '')
		...
		match self.tab.currentIndex():
			...
			case 1:
				if self.group_name_text.text():
					...
					if self.group_logo_text.text(): data['logo'] = self.group_logo_text.text()
